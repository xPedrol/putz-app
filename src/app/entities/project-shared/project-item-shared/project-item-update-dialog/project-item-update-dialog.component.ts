...
@Component({
  ...
  templateUrl: './project-item-update-dialog.component.html',
  styleUrls: ['./project-item-update-dialog.component.scss', '../../../../shared/themes/common.scss']
})
export class ProjectItemUpdateDialogComponent implements OnInit, OnDestroy {
  ...
  constructor(
    private dialogRef: NbDialogRef<ProjectItemUpdateDialogComponent>,
