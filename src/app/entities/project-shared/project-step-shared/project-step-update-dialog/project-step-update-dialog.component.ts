...
@Component({
  ...
  templateUrl: './project-step-update-dialog.component.html',
  styleUrls: ['./project-step-update-dialog.component.scss']
})
export class ProjectStepUpdateDialogComponent implements OnInit, OnDestroy {
  projectStep: IProjectStep | undefined;
  project: IProject | undefined;
  subject$ = new Subject();

  constructor(
    private dialogRef: NbDialogRef<ProjectStepUpdateDialogComponent>,
