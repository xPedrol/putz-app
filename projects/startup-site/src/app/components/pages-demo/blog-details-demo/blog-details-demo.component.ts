...
@Component({
  selector: 'app-blog-details-demo',
  templateUrl: './blog-details-demo.component.html',
  styleUrls: ['./blog-details-demo.component.scss']
})
export class BlogDetailsDemoComponent implements OnInit {
