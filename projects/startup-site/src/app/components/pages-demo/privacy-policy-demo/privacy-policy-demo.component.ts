...
@Component({
  selector: 'app-privacy-policy-demo',
  templateUrl: './privacy-policy-demo.component.html',
  styleUrls: ['./privacy-policy-demo.component.scss']
})
export class PrivacyPolicyDemoComponent implements OnInit {
